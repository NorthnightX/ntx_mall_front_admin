  ...
  <div class="user">
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="搜索：">
        ...
        <el-select size="small" v-model="formInline.isLock" placeholder="请选择部门">
          <el-option label="全部" value=""></el-option>
          <el-option label="运维人员" value="N"></el-option>
          <el-option label="系统管理员" value="Y"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="">
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="userName" label="用户账号" width="200">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="电话" width="200">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="邮箱" width="200">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="会员等级" width="100">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="总计消费" width="150">
      </el-table-column>
