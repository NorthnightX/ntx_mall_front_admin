<template>
  <div class="planeMsg">
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="40%" @click='closeDialog("edit")'>
      <el-form label-width="100px" ref="editPlaneForm" :model="editPlaneForm" :rules="rules">
        ...
        <el-form-item label="购买日期" prop="purchaseDate">
          <el-input size="small" v-model="editPlaneForm.purchaseDate" auto-complete="off" placeholder="请输入头等舱座位数"></el-input>
        </el-form-item>
    ...
    <el-dialog :title="title1" :visible.sync="addFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="90px" ref="editTypeForm" :model="addTypeForm" :rules="rules">
        <el-form-item label="飞机型号" prop="model">
          <el-input size="small" v-model="editPlaneForm.model" auto-complete="off"
                    placeholder="请输入飞机型号"></el-input>
        </el-form-item>
        <el-form-item label="客容量" prop="passengerCapacity">
          <el-input size="small" v-model="editPlaneForm.passengerCapacity" auto-complete="off"
                    placeholder="请输入客容量"></el-input>
        </el-form-item>
        <el-form-item label="头等舱座位数" prop="firstClassCapacity">
          <el-input size="small" v-model="editPlaneForm.firstClassCapacity" auto-complete="off" placeholder="请输入头等舱座位数"></el-input>
        </el-form-item>
        <el-form-item label="经济舱座位数" prop="economyClassCapacity">
          <el-input size="small" v-model="editPlaneForm.economyClassCapacity" auto-complete="off"
